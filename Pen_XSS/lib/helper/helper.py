...
╚═╝      ╚══╝╚══╝ ╚═╝  ╚═══╝╚═╝  ╚═╝╚══════╝╚══════╝
<<<<<<< STARTING >>>>>>>
"""%(R+"{v1.0.0}"+G,underline+C+"https://github.com/akash9773312/Pen_XSS"+N+G)
	
##=======
"""%(R+"{v0.5 Final}"+G,underline+C+"https://github.com/akash9773312/Pen_XSS"+N+G)
	
>>>>>>> branch 'master' of https://github.com/akash9773312/Pen_XSS
"""
