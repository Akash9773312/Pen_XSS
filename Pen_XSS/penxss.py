'''
Pen_XSS - 2023
This project was created by Akash Mishra.
...
epilog="""
Github: https://www.github.com/akash9773312/Pen_XSS
Version: 1.0.0
"""
def check(getopt):
...
def start():
	parse=argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter,usage="penxss -u <target> [options]",epilog=epilog,add_help=False)
